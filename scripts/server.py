...
@app.route('/api/geojson/Fauna Selvatica.geojson')
def api_fauna_selvatica():
    return _serve_geojson_safe('Fauna Selvatica.geojson')


@app.route('/api/geojson/Fauna Selvatica -Heatmap.geojson')
def api_fauna_heatmap():
